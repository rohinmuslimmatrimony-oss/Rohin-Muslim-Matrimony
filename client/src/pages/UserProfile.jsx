  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-cream-50 pt-24 pb-12 flex justify-center items-center">
        <span className="w-12 h-12 border-4 border-emerald-950 border-t-transparent rounded-full animate-spin"></span>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-cream-50 pt-24 pb-12 px-4 md:px-8 relative">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-6">
          <button onClick={() => navigate(-1)} className="text-slate-500 hover:text-emerald-900 font-semibold flex items-center gap-2 transition-colors">
            &larr; Back to Search
          </button>
        ...
        {/* Main Profile Card */}
        <div className="glass-card rounded-3xl border border-emerald-900/10 overflow-hidden shadow-sm">
          
          {/* Header Region */}
          <div className="h-40 md:h-56 bg-emerald-950 relative overflow-hidden">
          ...
          <div className="px-6 md:px-10 pb-10 relative">
            <div className="flex flex-col md:flex-row gap-6 relative -top-16">
              ...
              <div className="w-32 h-32 md:w-40 md:h-40 rounded-full border-4 border-cream-50 bg-slate-900 shadow-xl overflow-hidden relative flex-shrink-0 mx-auto md:mx-0">
                {profile.profilePhoto && profile.profilePhoto !== '/uploads/default-avatar.png' ? (
                  ...
                  <div className="w-full h-full flex items-center justify-center text-4xl text-gold-500 font-serif font-bold uppercase bg-emerald-900">
                    {profile.name[0]}
                  </div>
                )}
              ...
              <div className="pt-2 md:pt-16 flex-1 text-center md:text-left">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  <div>
                    <h1 className="text-3xl font-serif font-bold text-emerald-950 mb-1 flex items-center justify-center md:justify-start gap-2">
                  ...
                  {!isOwnProfile && (
                    <div className="flex flex-col gap-2">
                      {isConnected ? (
                        <span className="bg-emerald-100 text-emerald-800 px-4 py-2 rounded-full font-bold text-sm shadow-sm border border-emerald-200">
                          Mutual Connection ✓
                        </span>
                      ) : (
                        <button className="bg-gold-gradient text-emerald-950 px-6 py-2.5 rounded-full font-bold shadow-lg shadow-gold-500/20 hover:scale-105 transition-transform flex items-center gap-2">
                ...
                <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 mt-6 text-sm text-slate-600">
                  <span className="flex items-center gap-1.5 bg-emerald-50 px-3 py-1.5 rounded-lg border border-emerald-100">
                    <FaMapMarkerAlt className="text-emerald-700" /> {profile.city}
                  </span>
                  <span className="flex items-center gap-1.5 bg-emerald-50 px-3 py-1.5 rounded-lg border border-emerald-100">
                    <FaMosque className="text-emerald-700" /> {profile.sect}
                  </span>
                  <span className="flex items-center gap-1.5 bg-emerald-50 px-3 py-1.5 rounded-lg border border-emerald-100">
                    <FaUsers className="text-emerald-700" /> {profile.maritalStatus}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-8">
                {/* About Me */}
                <div>
                  <h3 className="text-lg font-serif font-bold text-emerald-950 mb-3 border-b border-emerald-900/10 pb-2">About Me</h3>
                  {isLocked ? (
                    ...
                    <p className="text-slate-600 leading-relaxed text-sm whitespace-pre-wrap bg-white p-4 rounded-xl border border-emerald-900/5">
                      {profile.about}
                    </p>
                  )}
                </div>
                ...
                {/* Personal Attributes */}
                <div>
                  <h3 className="text-lg font-serif font-bold text-emerald-950 mb-3 border-b border-emerald-900/10 pb-2">Personal & Religious Attributes</h3>
                  <div className="bg-white p-4 rounded-xl border border-emerald-900/5 grid grid-cols-2 gap-y-4 text-sm">
                    <div>
                    ...
                    <div className="col-span-2 pt-2 border-t border-slate-100">
                      ...
                      <span className="font-semibold text-emerald-800 bg-emerald-50 px-2 py-1 rounded inline-block">{profile.namazFrequency || "Not specified"}</span>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  <h3 className="text-lg font-serif font-bold text-emerald-950 mb-3 border-b border-emerald-900/10 pb-2">Contact Details</h3>
                  <div className="bg-emerald-950/5 p-4 rounded-xl border border-emerald-900/10 space-y-4">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-full bg-emerald-100 text-emerald-700 flex items-center justify-center"><FaPhoneAlt className="text-xs" /></div>
                    ...
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-full bg-emerald-100 text-emerald-700 flex items-center justify-center"><FaEnvelope className="text-xs" /></div>
                      <div className="flex flex-col">
                    ...
                    {profile.phoneNumber?.includes('🔒') && !isOwnProfile && (
                      <div className="mt-2 text-xs text-emerald-800 bg-emerald-100 p-2 rounded flex items-start gap-2">
              ...
              <div className="space-y-8">
                ...
                {/* Professional Info */}
                <div>
                  <h3 className="text-lg font-serif font-bold text-emerald-950 mb-3 border-b border-emerald-900/10 pb-2">Education & Career</h3>
                  <div className="bg-white p-4 rounded-xl border border-emerald-900/5 space-y-4 text-sm">
                    <div className="flex items-start gap-3">
                      <FaBriefcase className="text-emerald-700 mt-1 text-lg" />
                      <div>
                    ...
                    <div className="flex items-start gap-3">
                      <FaGraduationCap className="text-emerald-700 mt-1 text-lg" />
                      <div>
                ...
                {/* Family Details */}
                <div>
                  <h3 className="text-lg font-serif font-bold text-emerald-950 mb-3 border-b border-emerald-900/10 pb-2">Family Background</h3>
                  <div className="bg-white p-4 rounded-xl border border-emerald-900/5 space-y-3 text-sm">
                ...
                {/* Partner Preferences */}
                <div>
                  <h3 className="text-lg font-serif font-bold text-emerald-950 mb-3 border-b border-emerald-900/10 pb-2">Partner Preferences</h3>
                  <div className="bg-white p-4 rounded-xl border border-emerald-900/5 space-y-3 text-sm">
                    <div className="flex justify-between items-center border-b border-slate-50 pb-2">
      ...
      {isReportModalOpen && (
        <div className="fixed inset-0 bg-slate-900/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl p-6 w-full max-w-md shadow-2xl animate-fadeIn">
            <h3 className="text-xl font-serif font-bold text-emerald-950 mb-2">Report Profile</h3>
