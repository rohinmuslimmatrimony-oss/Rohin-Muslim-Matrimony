...
const MobileMatchesFeed = () => {
  ...
  return (
    <div className="w-full flex flex-col min-h-screen bg-[#faf8f5] pb-24 font-outfit">
      {/* Pills Navigation */}
      <div className="sticky top-[72px] z-45 bg-white flex items-center justify-center gap-2.5 py-4 px-2 shadow-sm overflow-x-auto">
        <button onClick={() => navigate('/search')} className="flex items-center gap-1.5 px-3 py-2 rounded-xl border border-slate-200 text-slate-600 text-xs font-bold hover:bg-slate-50 transition-colors shrink-0">
