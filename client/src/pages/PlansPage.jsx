...
const PlansPage = () => {
  ...
  return (
    <div className="min-h-screen bg-cream-50 pt-20 pb-20 px-4 md:px-8 relative overflow-hidden">
      {/* Background Decor */}
      <div className="absolute top-[0%] left-[50%] -translate-x-1/2 w-full max-w-3xl h-[400px] bg-gradient-to-b from-emerald-900/10 to-transparent rounded-full blur-[100px] -z-10"></div>
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
        ...
        {/* FREE PLAN */}
        <div className="glass-card rounded-3xl p-8 border border-emerald-900/10 flex flex-col hover:-translate-y-2 transition-transform duration-300">
          <div className="mb-6">
            <h3 className="text-slate-500 font-bold uppercase tracking-wider text-sm mb-2">Basic</h3>
            <div className="flex items-end gap-1">
              <span className="text-4xl font-serif font-bold text-emerald-950">Free</span>
            </div>
          </div>
          <ul className="flex-1 space-y-4 mb-8">
            <li className="flex items-start gap-3 text-sm text-slate-700">
              <FaCheckCircle className="text-emerald-600 text-lg mt-0.5" />
          ...
          <button 
            ...
            className="w-full py-3.5 rounded-full font-bold text-emerald-900 bg-emerald-900/10 hover:bg-emerald-900/20 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
        ...
        {/* PREMIUM PLAN */}
        <div className="glass-card-dark rounded-3xl p-8 border border-emerald-700 flex flex-col transform scale-105 shadow-2xl relative">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-gold-gradient px-4 py-1 rounded-full text-emerald-950 text-xs font-bold uppercase tracking-wider shadow-lg flex items-center gap-1.5">
            <FaStar /> Most Popular
          </div>
          <div className="mb-6">
            <h3 className="text-emerald-400 font-bold uppercase tracking-wider text-sm mb-2">Premium</h3>
            <div className="flex items-end gap-1">
          ...
          <button 
            ...
            className="w-full py-3.5 rounded-full font-bold bg-gold-gradient text-emerald-950 hover:shadow-gold-500/30 hover:scale-105 transition-all disabled:opacity-50 disabled:scale-100 disabled:cursor-not-allowed"
          >
        ...
        <div className="glass-card rounded-3xl p-8 border border-gold-500/30 flex flex-col hover:-translate-y-2 transition-transform duration-300 relative overflow-hidden">
          ...
          <div className="mb-6 relative z-10">
            ...
            <div className="flex items-end gap-1">
              <span className="text-4xl font-serif font-bold text-emerald-950">₹{prices.elite}</span>
          ...
          <ul className="flex-1 space-y-4 mb-8 relative z-10">
            <li className="flex items-start gap-3 text-sm text-slate-700">
              ...
              <span className="font-bold text-emerald-900">Unlimited profile views</span>
            </li>
            <li className="flex items-start gap-3 text-sm text-slate-700">
              <FaCheckCircle className="text-gold-500 text-lg mt-0.5" />
          ...
          <button 
            ...
            className="w-full py-3.5 rounded-full font-bold bg-emerald-950 text-gold-400 hover:bg-emerald-900 transition-colors disabled:opacity-50 disabled:cursor-not-allowed relative z-10 border border-emerald-800"
          >
